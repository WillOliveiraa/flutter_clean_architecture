...
import 'package:flutter_clean_architecture/CleanArchtecture/layers/infra/errors/repository_exception.dart';
...
class BankAccountRepositoryImp implements BankAccountRepository {
  ...
  Future<Either<Failure, List<BankAccount>>> findAll() async {
    try {
      ...
      return Right(
          result.map((e) => this._mapper.from(e)).toList().cast<BankAccount>());
    } catch (e) {
